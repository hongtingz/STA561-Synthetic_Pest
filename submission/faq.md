...
the lack of real positive pest images, and the dependence of final metrics on
the latest DCC render/training artifacts. These limitations affect how strongly
...
## 22. How can later DCC results update the repository without changing the design?
...
failure-case images. If longer DCC jobs finish after the current documentation
pass, the team can update the quantitative tables and notebook displays by
copying in those generated artifacts or summarizing them in the submission
documents. The implementation does not need a redesign for those updates.
