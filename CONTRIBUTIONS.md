...
The current DCC result snapshot is recorded under `submission/results/`: the
dataset sanity check passes, ViT/YOLOS-tiny clears 80% TDR on rendered
validation data, and real-negative false-positive control remains the main
